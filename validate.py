...
class validate: #the validate class is pre vaidating every input
  def plate(self, plate):
    try:
      ...
      error(11,'valid.plate() error', True)
      return None
  ...
  def site(self, site):
    try:
      ...
      error(12, str(e)+' vaild.site() error', True)
      return None
  ...
  def time(self, time):
    try:
      ...
      error(13, str(e)+' vaild.time() error', True)
      return False
  ...
  def confidence(self, confidence):
    try:
      ...
      error(14, str(e)+' vaild.confidence() error', True)
      return False
  ...
  def cam(self, cam):
    try:
      ...
      error(15, str(e)+' vaild.cam() error', True)
      return False

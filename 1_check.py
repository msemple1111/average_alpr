...
def camera_1():
  ...
  1_plate = re.compile("[A-Z]{2}[0-9]{2}[A-Z]{3}") #https://gist.github.com/danielrbradley/7567269
  2_plate = re.compile("[A-Z][0-9]{1,3}[A-Z]{3}")
  3_plate = re.compile("[A-Z]{3}[0-9]{1,3}[A-Z]")
  4_plate = re.compile("[0-9]{1,4}[A-Z]{1,2}")
  5_plate = re.compile("[0-9]{1,3}[A-Z]{1,3}")
  6_plate = re.compile("[A-Z]{1,2}[0-9]{1,4}")
  7_plate = re.compile("[A-Z]{1,3}[0-9]{1,3}")
  if 1_plate.match() or 2_plate.match() or 3_plate.match() or 4_plate.match() or 5_plate.match() or 6_plate.match() or 7_plate.match():
